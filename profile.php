                            ...
                            <!-- Card Body -->
                                ...
                                if($resultSelectFromID->num_rows > 0) {
                                    ...
                                    echo "<div class='card-body'>
                                        ...
                                        <div class='input-group mb-3'>
                                            <div class='input-group-prepend'>
                                                <span class='input-group-text' id='basic-addon2'>Hire Date</span>
                                            </div>  
                            ...
                            <div class='card shadow mb-4'>
                                ...
                                echo" <div class='card-footer'>
                                    <ul class='list-group list-group-flush'>
                                        <li class='list-group-item'>First name: <span class='text-info'>".$rowSelectFromID["fisrt_name"]."</span></li>
                                        <li class='list-group-item'>Last name: <span class='text-info'>".$rowSelectFromID["last_name"]."</span></li>
                                    </ul>
                                </div>";
                                    }
                                };
