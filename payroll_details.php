                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            <a href="payroll.php" class="btn btn-primary btn-icon-split">
                                ...
                                <span class="text" data-toggle="modal" data-target="#importExcel">Quay lại</span>
                    ...
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <form action="" method="GET" style="display: flex; align-items: center";>
                            ...
                            <select name="month" id="month" style="padding: 5px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; margin-right: 10px;">
                                <?php
                                for ($i = 1; $i <= 12; $i++) {
                            ...
                            <select name="year" id="year" style="padding: 5px; font-size: 14px; border: 1px solid #ccc; border-radius: 4px; margin-right: 10px;">
                                <?php
                                $current_year = date('Y');
                                ...
                                ?>
                            <input type="submit" value="Tìm kiếm" style="padding: 5px; font-size: 14px; border: 1px solid #1cc88a; border-radius: 4px; background-color: #1cc88a; color: #fff; cursor: pointer; transition: background-color 0.3s;">
                        </form>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                        <table class='table table-bordered' id='payroll_detail' width='100%' cellspacing='0'>
                            <thead>
                            <tr>
                                <th>STT</th>
                                <th>Ngày</th>
